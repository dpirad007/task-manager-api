...
router.post('/users/login',async (req,res) => {
    try{
        const user = await User.findByCredentials(req.body.email, req.body.password)// "U"ser -> to access collection
...
router.get('/users/me', auth , async (req,res) => { //we put the auth middleware between our route and async function
    res.send(req.user)
})
